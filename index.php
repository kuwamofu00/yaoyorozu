      ...
      <div class="row featurette">
        <div>
          <div class="col-md-7 order-md-2">
            <h3>販売価格について</span></h3>
          <p class="lead">
            7月上旬に正確な販売価格を決定いたします。<br>
            オクラは500ｇ1000円を予定しております。<br>
            ぶどうの価格は収穫量などにより多少変動致します。<br>
            ・デラウェア 1キロ（7房前後）2500円（税込み）予定<br>
            ・シャインマスカット 1.5キロ（2房〜3房）4000円（税込み）予定<br>
            ※シャインマスカットひと房700g〜800g<br>
            ※送料は別途発生致します。配送業者ヤマト運輸でお届け先によって金額が変化致します。<br>
            ※ご購入のお客様へ、送料はお客様負担になりますが、気持ち程度になりますが
            他の野菜をサービスさせて頂きます。<br><br>
          </p>
        </div>
      </div>
